...
class GamePlay:
    ...
    ace_of_spades = r'ace_of_spades.png'
    ace_of_clubs = r'ace_of_clubs.png'
    ace_of_diamonds = r'ace_of_diamonds.png'
    ace_of_hearts = r'ace_of_hearts.png'

    king_of_spades = r'king_of_spades2.png'
    king_of_clubs = r'king_of_clubs2.png'
    king_of_diamonds = r'king_of_diamonds2.png'
    king_of_hearts = r'king_of_hearts2.png'

    queen_of_spades = r'queen_of_spades2.png'
    queen_of_clubs = r'queen_of_clubs2.png'
    queen_of_diamonds = r'queen_of_diamonds2.png'
    queen_of_hearts = r'queen_of_hearts2.png'

    jack_of_spades = r'jack_of_spades2.png'
    jack_of_clubs = r'jack_of_clubs2.png'
    jack_of_diamonds = r'jack_of_diamonds2.png'
    jack_of_hearts = r'jack_of_hearts2.png'

    ten_of_spades = r'10_of_spades.png'
    ten_of_clubs = r'10_of_clubs.png'
    ten_of_diamonds = r'10_of_diamonds.png'
    ten_of_hearts = r'10_of_hearts.png'

    nine_of_spades = r'9_of_spades.png'
    nine_of_clubs = r'9_of_clubs.png'
    nine_of_diamonds = r'9_of_diamonds.png'
    nine_of_hearts = r'9_of_hearts.png'

    eight_of_spades = r'8_of_spades.png'
    eight_of_clubs = r'8_of_clubs.png'
    eight_of_diamonds = r'8_of_diamonds.png'
    eight_of_hearts = r'8_of_hearts.png'

    seven_of_spades = r'7_of_spades.png'
    seven_of_clubs = r'7_of_clubs.png'
    seven_of_diamonds = r'7_of_diamonds.png'
    seven_of_hearts = r'7_of_hearts.png'

    six_of_spades = r'6_of_spades.png'
    six_of_clubs = r'6_of_clubs.png'
    six_of_diamonds = r'6_of_diamonds.png'
    six_of_hearts = r'6_of_hearts.png'

    five_of_spades = r'5_of_spades.png'
    five_of_clubs = r'5_of_clubs.png'
    five_of_diamonds = r'5_of_diamonds.png'
    five_of_hearts = r'5_of_hearts.png'

    four_of_spades = r'4_of_spades.png'
    four_of_clubs = r'4_of_clubs.png'
    four_of_diamonds = r'4_of_diamonds.png'
    four_of_hearts = r'4_of_hearts.png'

    three_of_spades = r'3_of_spades.png'
    three_of_clubs = r'3_of_clubs.png'
    three_of_diamonds = r'3_of_diamonds.png'
    three_of_hearts = r'3_of_hearts.png'

    two_of_spades = r'2_of_spades.png'
    two_of_clubs = r'2_of_clubs.png'
    two_of_diamonds = r'2_of_diamonds.png'
    ...
    def restart(self):
        ...
        game.draw.rect(self.screen, (btn_colour),[player.deal_x_pos, player.deal_y_pos, player.deal_x_len, player.deal_y_len])
        self.screen.blit(deal, (player.deal_x_pos + 10, player.deal_y_pos + 6))
        self.count_value = 0
        self.bet_value = 0
        self.initial_balance = 1000
        self.initial_player_hand_time_flag = 0
        self.initial_time = 999999999999999999
        self.new_round()

        player.player_hand_value = 0
        player.deal_btn_flag = 0
